...
zed_theme_file="$HOME/.config/zed/themes/pink-high-contrast.json"
...
test -f "$alacritty_conf" && cp -v "$alacritty_conf" "$proj_home/.config/alacritty/alacritty.linux.toml"
...
test -f "$zed_theme_file" && cp -v "$zed_theme_file" "$proj_home/.config/zed/themes/pink-high-contrast.json"
test -f "$zed_conf" && cp -v "$zed_conf" "$proj_home/.config/zed/settings.linux.json"
