...
test -f "$alacritty_conf" && cp -v "$alacritty_conf" "$proj_home/.config/alacritty/alacritty.mac.toml"
...
test -f "$zed_conf" && cp -v "$zed_conf" "$proj_home/.config/zed/settings.mac.json"
