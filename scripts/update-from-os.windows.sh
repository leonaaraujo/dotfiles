...
alacritty_conf="$HOME/AppData/Roaming/alacritty/alacritty.toml"
nvim_conf="$HOME/AppData/Local/nvim/init.vim"
vim_conf="$HOME/.vimrc"
vscodium_conf="$HOME/scoop/apps/vscodium/current/data/user-data/User/settings.json"
vscode_conf="$HOME/AppData/Roaming/Code/User/settings.json"
tmux_conf="$HOME/.tmux.conf"
psmux_conf="$HOME/.psmux.conf"
...
test -f "$alacritty_conf" && cp -v "$alacritty_conf" "$proj_home/.config/alacritty/alacritty.windows.toml"
test -f "$vscodium_conf" && cp -v "$vscodium_conf" "$proj_home/vscodium/current/data/user-data/User/settings.json"
test -f "$vscode_conf" && cp -v "$vscode_conf" "$proj_home/Code/User/settings.json"
test -f "$tmux_conf" && cp -v "$tmux_conf" "$proj_home/.tmux.conf"
test -f "$psmux_conf" && cp -v "$psmux_conf" "$proj_home/.psmux.conf"
